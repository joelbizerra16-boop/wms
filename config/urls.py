...
from apps.core.views import home, minuta, minuta_pdf
...
from apps.core.views_web import (
    ...
    importar_xml_web,
    limpar_dados_importacao_web,
    confirmar_scan_entradas_web,
    liberar_entrada_nf_web,
    produtos_web,
    separacao_imprimir_web,
    remover_scan_nf_api,
    rotas_web,
    separacao_exec_web,
    separacao_aceite_web,
    separacao_lista_web,
...
urlpatterns = [
    ...
    path('separacao/<int:tarefa_id>/imprimir/', separacao_imprimir_web, name='web-separacao-imprimir'),
    path('separacao/<int:tarefa_id>/aceite/', separacao_aceite_web, name='web-separacao-aceite'),
