...
DB_TELEMETRY_ENABLED = config('DB_TELEMETRY_ENABLED', default=True, cast=bool)
DB_QUERY_SLOW_MS = config('DB_QUERY_SLOW_MS', default=25, cast=int)
ORM_N_PLUS_ONE_THRESHOLD = config('ORM_N_PLUS_ONE_THRESHOLD', default=8, cast=int)
SEPARACAO_SLOW_LOG_MS = config('SEPARACAO_SLOW_LOG_MS', default=500, cast=int)
CONFERENCIA_SLOW_LOG_MS = config('CONFERENCIA_SLOW_LOG_MS', default=500, cast=int)
DASHBOARD_CACHE_TTL = config('DASHBOARD_CACHE_TTL', default=10, cast=int)
